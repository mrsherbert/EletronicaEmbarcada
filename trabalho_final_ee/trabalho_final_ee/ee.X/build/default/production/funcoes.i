...
void media(uint16_t timer) {
    static uint16_t tempo_recebido[2] = {0, 0};
    static uint8_t indice = 0;
    tempo_recebido[indice] = timer;
    indice ^= 1;
...
void DRMotordePassos(){
    ...
    if(posicao_val_futura > 460){
        posicao_val_futura = 460;
    }
    if(ciclo_util_futuro > 1023){
        ciclo_util_futuro = 1023;
    }
...
void modo_valvula(){
    ...
    if(integrativo > 350) { integrativo = 350; }
    if(integrativo < -350) { integrativo = -350; }
